...
def eda_endpoint(endpoints):
    ...
    def dq_result_history():
        ...
        output = [{'ColunmList':user['ColunmList'], 'dataset_shape':user['dataset_shape'], 'df_head':user['df_head'], 'df_tail':user['df_tail'], 'size':user['size'], 'null_values':user['null_values'], 'unique_values':user['unique_values'], 'df_datatypes':user['df_datatypes'], 'df_duplicate_value':user['df_duplicate_value'], 'df_des':user['df_des'], 'file_name':user['file_name'], 'current_time':user['current_time']} for user in users]
        resp ['data']=output
    ...
    def DQ_graph():
       ...
       print(graph_1)
       plt.hist(df[graph_1])
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph1.png")
       plt.clf()
    ...
    def DQ_graph_2():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph2.png")
       plt.clf()
    ...
    def DQ_graph_3():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph3.png")
       plt.clf()
    ...
    def DQ_graph_4():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph4.png")
       plt.clf()
    ...
    def DQ_graph_5():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph5.png")
       plt.clf()
    ...
    def DQ_graph_6():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph6.png")
       plt.clf()
    ...
    def DQ_graph_7():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph7.png")
       plt.clf()
    ...
    def DQ_graph_8():
       ...
       plt.savefig(r"C:\Users\wishwa\Desktop\DIgiVerz-main\src\assests\graph8.png")
       plt.clf()
